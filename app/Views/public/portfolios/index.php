...
<section class="relative pt-32 pb-20 bg-slate-900 overflow-hidden">
    <div class="absolute inset-0 opacity-10">
        ...
        <div class="absolute top-1/2 right-0 w-64 h-64 bg-primary-400 rounded-full filter blur-3xl translate-x-1/2"></div>
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10 text-center">
        ...
        <p class="max-w-2xl mx-auto text-lg text-slate-400">Bukti nyata dedikasi kami dalam menghadirkan solusi teknologi berkualitas untuk setiap klien.</p>
    </div>
</section>
...
<section class="py-24 bg-slate-50">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div class="group relative bg-white rounded-[2.5rem] border border-slate-100 overflow-hidden hover:shadow-2xl hover:shadow-slate-200 transition-all duration-500">
                <div class="aspect-video overflow-hidden relative">
                    <?php if ($item->thumbnail): ?>
                        <img src="<?= base_url($item->thumbnail) ?>" class="w-full h-full object-cover group-hover:scale-105 transition duration-700">
                    <?php endif; ?>
                    <div class="absolute top-6 left-6">
                        <span class="px-4 py-2 bg-white/90 backdrop-blur shadow-xl rounded-full text-xs font-bold text-slate-900"><?= $item->service_title ?></span>
                    </div>
                </div>
                <div class="p-10">
                    <div class="flex justify-between items-start mb-4">
                        <h3 class="text-2xl font-bold text-slate-900 group-hover:text-primary-600 transition"><?= $item->title ?></h3>
